...
namespace JwtIdentity.Service.Services
{
    public class TokenService : ITokenService
    {
        ...
        public TokenDto CreateToken(UserApp userApp)
        {
            ...
            JwtSecurityToken jwtSecurityToken = new JwtSecurityToken(issuer: _tokenOption.Issuer,
                ...
                claims: GetClaim(userApp, _tokenOption.Audience), signingCredentials: signingCredentials);
        ...
        public ClientTokenDto CreateTokenByClient(Client client)
        {
            ...
            JwtSecurityToken jwtSecurityToken = new JwtSecurityToken(issuer: _tokenOption.Issuer,
                expires: accessTokenExpiration, notBefore: DateTime.Now,
                claims: GetClaimsByClient(client), signingCredentials: signingCredentials);
